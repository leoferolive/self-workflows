...
program
  ...
  .option(
    ...
    'Repositório de templates (self-workflows)',
    'self-workflows'
  )
  .option(
    '--domain <domain>',
    'Domínio para ingress (padrão: leoferolive.com.br)',
    'leoferolive.com.br'
  )
  ...
  .action((type, name, options) => {
    ...
    console.log(
      chalk.white(`   6. Configure os secrets no GitHub (TAILSCALE_AUTHKEY, KUBECONFIG)`)
    );
